...
@Data
public class MavenMirrorMetadata implements MirrorMetadata {
    ...
    public MavenMirrorMetadata(Mirror mavenMirror) {
    ...
    public Credentials getCredentials() {
        ...
        if (server.getUsername() != null && server.getPassword() != null) {
            return new MavenServerUsernamePasswordCredentials(server);
        }
    ...
    private boolean matches(MavenArtifactRepository repository, String mirrorOf) {
        ...
        if (mirrorOf.equals(repository.getName()) || mirrorOf.equals(repository.getUrl().toString())) {
            return true;
        }
